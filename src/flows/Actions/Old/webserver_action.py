...
class WebserverAction(Action):
    ...
    def on_init(self):
        ...
        global_module.LOGGER.info(str.format(
    ...
    def on_cycle(self):
        ...
        MyServerRequestHandler.message["sleep_interval"] = (
            str(global_module.CONFIG_MANAGER.sleep_interval))
...
class MyServerRequestHandler(BaseHTTPRequestHandler):
    ...
    def log_message(self, format, *args):
        string_to_log = str.format("{0} - - [{1}] {2}",
                                   ...
                                   format % args)
        global_module.LOGGER.debug(string_to_log)
...
class DannyHTTPServer(HTTPServer):
    ...
    def stop(self):
        ...
        self.is_alive = False
        self.server_close()
        global_module.LOGGER.info("Server Stops " + (str(self.server_address)))
